...
- Name: app.spec.ts >> login: page renders with all elements
- Location: tests/app.spec.ts:13:5
...
Locator: getByTestId('auth-login-title')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByTestId('auth-login-title')
